...
import spaceSurvival.model.gameObject.weapon.ElectricBullet;

public class ElectricBulletPhysicsComponent implements PhysicsComponent {

	@Override
	public void update(int dt, GameObject abstractObj, World w) {
		ElectricBullet obj = (ElectricBullet) abstractObj;
