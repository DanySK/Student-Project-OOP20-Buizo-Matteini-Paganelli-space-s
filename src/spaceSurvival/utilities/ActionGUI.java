...
public enum ActionGUI {
    ...
    ID_DEAD(10, "DEAD", SoundPath.MENU_SOUND, StateLevelGUI.FOREGROUND);
    ...
    private ActionGUI(final int id, final String name, final SoundPath sound, final StateLevelGUI level){
        this.id = id;
        this.name = name;
        this.sound = sound;
        this.level = level;
